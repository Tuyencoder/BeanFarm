...
import com.TTT.Tniciu_API.Utils.PGPUtils;
import com.TTT.Tniciu_API.Utils.PasswordHasher;
...
public class AccountService {
    ...
    public boolean checkOldPassword(String email, String oldPassword) {
        ...
        return PasswordHasher.verifyPassword(oldPassword, account.getPassword());
    }
